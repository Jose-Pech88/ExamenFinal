...
{
    public class PaqueteriaFedexStrategy : ITransportistas
    {
        public List<IMediosTransportes> lstMediosTransporte { get; set; }
        public decimal dMargenUtilidad { get { return 50; } }
        public string cPaqueteria { get { return "Fedex"; } }
        private readonly IGeneradorMensajes GeneradorMensajes;
        public PaqueteriaFedexStrategy(IGeneradorMensajes _generadorMensajes)
        {
